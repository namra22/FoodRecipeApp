...
return(
   ...
   <h2 className="text-3xl font-bold text-black">
     <NavLink to={'/FoodRecipeApp'} className='hover:text-green-700 transition duration-300'>Food Recipes</NavLink>
   </h2>
   ...
   <ul className="flex gap-5">
     <li>
       <NavLink to={'/FoodRecipeApp'} className='text-black hover:text-green-700 hover:bg-green-300 duration-300' >Home</NavLink>
     </li>
     <li>
